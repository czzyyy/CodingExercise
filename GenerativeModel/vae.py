# https://github.com/mengli/MachineLearning/blob/master/tensorflow/vae/vae_mnist.py
# https://jmetzen.github.io/2015-11-27/vae.html
# http://www.sohu.com/a/165055924_390227
...
class Basic_VAE(object):
    ...
    def train(self):
        ...
        with tf.Session() as sess:
            ...
            # cluster
            #z_m, z_s = sess.run([z_mean, z_stddev], feed_dict={X: self.test_data})
