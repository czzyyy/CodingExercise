    ...
    with tf.Session() as sess:
        ...
        for i in range(class_num):
            ...
            for j in range(10):
                ...
                # plt.imsave('F:/tf_board/aae_mnist_y_style/' + str(i) + 'gaussian_generate1.png',
                #            gaussian_samples[1].reshape((28,28)),cmap='Greys_r')
        # for i in range(class_num):
        #     gaussian_onehot = np.zeros(shape=[batch_size,class_num])
        #     gaussian_onehot[:,i] = 1
        #     gaussian_samples_l = sess.run(generated_images_l, feed_dict={input_imgs_l: test_data.images[0:batch_size],
        #                                                                  input_onehot_l: gaussian_onehot})
        #     plt.imsave('F:/tf_board/aae_mnist_y_style/' + str(i) + 'gaussian_generate_l0.png',
        #                gaussian_samples_l[0].reshape((28,28)),cmap='Greys_r')
        #     # plt.imsave('F:/tf_board/aae_mnist_y_style/' + str(i) + 'gaussian_generate_l1.png',
        #     #            gaussian_samples_l[1].reshape((28,28)),cmap='Greys_r')
        print('generate done!')
